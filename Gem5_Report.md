...
* **Στατική Ισχύς ($P_{static}$):** Θεωρείται ανάλογη του μεγέθους της cache ($x$). Χρησιμοποιήθηκαν οι τιμές **0.1W ανά 1MB για την L2** και **0.01W για την L1** (βάσει McPAT Framework για τεχνολογία 28nm https://github.com/HewlettPackard/mcpat/blob/master/README).
